...
# Разделы должны быть непересекающимися поддеревьями Confluence: страница
# хранится по page_id один раз, и пересечение отняло бы её у одного из разделов.
# Спецификации требований (1933456) лежат внутри «Стадий проекта» и приходят
# вместе с ними.
DEFAULT_SECTIONS = {
