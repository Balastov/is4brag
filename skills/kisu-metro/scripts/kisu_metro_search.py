#!/usr/bin/env python3
"""
Гибридный поиск по 4 разделам KISU Metro (семантика + TF-IDF).
Объединяет: Стадии проекта (включая спецификации требований), Архитектура,
...
Спецификации требований лежат внутри «Стадии проекта» и отдельным разделом не ищутся.
"""
